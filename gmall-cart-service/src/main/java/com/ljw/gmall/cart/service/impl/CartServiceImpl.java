...
public class CartServiceImpl implements CartService {
    ...
    @Override
    public void delCart(OmsOrderItem orderItem) {
        String id = orderItem.getProductId();
        OmsCartItem omsCartItem = new OmsCartItem();
        omsCartItem.setProductId(id);
